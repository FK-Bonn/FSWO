...
%todo: dynamtische Absatz referenzen?
...
Die Wahlleitung macht die Wahl spätestens bis zum 18. Tag vor dem ersten Wahltag nach den Regeln des \change{\S~10a}{\S~12} dieser Ordnung bekannt. %todo dynamische Referenz
...
\item eine Darstellung des Wahlsystems nach \S~7, %todo dynamische Referenz
...
Die Wahlleitung gibt unverzüglich die Namen der gemäß \S~11 Abs. 3 und 4 als gültig zugelassenen Kandidaturen öffentlich innerhalb der Studierendenschaft und an geeigneter Stelle im Internet bekannt. %todo Referenz
...
\item Art des Wahlsystems (vgl. \S\S~2, 25, 26) %todo Referenzen
\item der Wahltermin
...
Wurde bei einer Wiederholungswahl nach Ablauf einer Nachfrist keine Kandidatur eingereicht, so enthält der Stimmzettel keine Kandidaturen, sondern lediglich das Freifeld gemäß \S~15 Abs. 3. %todo referenz...
