...
\newcommand*{\refClausePar}[1]{\hyperref[#1]{\refClause{#1}~\refParS{#1}}}
...
gem. \refClausePar{cls-veroeffentlichungen-wa:abs-webpraesenz} zu veröffentlichen und gem. \refClausePar{cls-wahlpruefung:abs-aufbewahrung} dieser Ordnung durch den FSR im Original zur Einsichtnahme aufzubewahren.
